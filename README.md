# `Dierckx_jll.jl` (v0.1.1+0)

[![deps](https://juliahub.com/docs/Dierckx_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Dierckx_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/e7bf3cfc92b3cdcffafc77e3edb1bd015fd6eb75/D/Dierckx/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://github.com/scipy/scipy/releases/download/v1.15.1/scipy-1.15.1.tar.gz (SHA256 checksum: `033a75ddad1463970c96a88063a1df87ccfddd526437136b6ee81ff0312ebdf6`)
