...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Dierckx_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cd4c43a9-7502-52ba-aa6d-59fb2a88580b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Dierckx", artifacts_toml) for e in artifacts["Dierckx"]]
...
if best_platform === nothing
    @debug("Unable to load Dierckx; unsupported platform $(triplet(platform_key_abi()))")
else
