# Autogenerated wrapper script for Dierckx_jll for x86_64-apple-darwin14-libgfortran3
export libddierckx
...
const libddierckx_splitpath = ["lib", "libddierckx.dylib"]
...
const libddierckx = "@rpath/libddierckx.dylib"
